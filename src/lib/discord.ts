export const serverId = '826405737093136434';           //Discord ID of the server where the bingo game will run
export const bingoPlayerRole = '1146738386544111626';   //Discord ID of the role of the players - only people with this role will be allowed to play
